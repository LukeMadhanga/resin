...
This is a sample template for resin - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name resin --tail
```
...
```bash
aws cloudformation delete-stack --stack-name resin
```
